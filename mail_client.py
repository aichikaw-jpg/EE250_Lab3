...
def get_inbox(recipient: str) -> None:
    ...
    Displays the inbox to the user. 

    Args:
        recipient (str): The recipient of the mail

    Returns:
        None: No return variable
    """
...
def get_sent(sender: str) -> None:
    ...
    Gets the sent emails to the user. 
...
def get_mail(mail_id: str) -> None:
    ...
    Gets the mail using the mail id

    Args: 
        mail_id(str): The mail id of an email
...
def delete_mail(mail_id: str) -> None:
    ...
    Deletes one of the emails

    Args: mail_id(str): The mail id of an email
